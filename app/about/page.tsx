            ...
            <div className="container max-w-screen-xl mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
                    <div className="max-w-2xl">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6">{dictionary.about.title}</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        {/* Who I Am */}
                        <section>
                            <h2 className="text-2xl font-bold mb-4">{dictionary.about.whoIAmTitle}</h2>
                            <div className="prose prose-neutral dark:prose-invert max-w-none space-y-4 text-muted-foreground">
                                {dictionary.about.whoIAmContent.map((paragraph, index) => (
                        ...
                        {/* Education Section */}
                        <section>
                            <h2 className="text-2xl font-bold mb-6">{dictionary.about.educationTitle}</h2>
                            <div className="space-y-8">
                                {dictionary.about.education.map((item, index) => (
                                    <div key={index} className={`relative pl-6 border-l-2 ${index === 0 ? 'border-primary' : 'border-muted-foreground/30'}`}>
                                        ...
                                        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-1">
                                            <h3 className={`text-lg font-bold ${index === 0 ? '' : 'text-muted-foreground font-semibold'}`}>{item.degree}</h3>
                        ...
                        {/* Skills Section */}
                        <section>
                            <h2 className="text-2xl font-bold mb-6">{dictionary.about.skillsTitle}</h2>

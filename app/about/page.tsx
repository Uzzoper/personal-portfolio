        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-muted-foreground">
              Hey there! I'm Juan Peruzzo, a software developer passionate about building modern digital experiences.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              ...
              <div className="prose prose-neutral dark:prose-invert max-w-none space-y-4 text-muted-foreground">
                <p>
                  I'm a tech enthusiast and software developer focused on creating clean, efficient, and user-centric applications. 
                  My journey began in <strong>Electrical Engineering at UTFPR</strong> (2020–2024), where I built a strong analytical foundation. 
                  However, I discovered my true calling in <strong>Software Engineering</strong>: the incredible power to build virtually anything from scratch.
                </p>
                <p>
                  ...
                  For me, programming is the ultimate tool for innovation, allowing the creation of products that can reach millions and change the way we interact with the world.
                </p>
                <p>
                  I specialize in backend development with <strong>Java and Spring Boot</strong>, while also crafting modern frontends with <strong>React and Next.js</strong>. 
                  I believe in writing code as an engineer—prioritizing <strong>Clean Architecture</strong>, performance, and the scalability required for the next generation of software companies.
                </p>
                <p>
                  I am <strong>obsessed with technology</strong> and dedicated to learning something new every single day. 
                  For me, it's not just about writing code; it's a constant pursuit to refine my craft and become the best engineer I can be.
                </p>
              </div>
            </section>
                ...
                <div className="relative pl-6 border-l-2 border-muted-foreground/30">
                  ...
                  <div className="mt-3 p-3 rounded-md bg-muted/50 border-l-4 border-yellow-500/50">
                    <p className="text-sm text-muted-foreground">
                      <strong>Note:</strong> Coursework completed through the 6th semester. I chose to discontinue the program to fully dedicate my career to <strong>Software Engineering</strong>, driven by my passion for tech and building scalable digital systems.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Card className="border-primary/50 bg-primary/5">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  I'm currently looking for new opportunities. If you have a project in mind or want to collaborate, let's talk!
                </p>
